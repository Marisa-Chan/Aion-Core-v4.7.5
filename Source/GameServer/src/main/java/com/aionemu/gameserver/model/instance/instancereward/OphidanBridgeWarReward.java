...
import com.aionemu.gameserver.model.instance.playerreward.OphidanBridgeWarGroupReward;
import com.aionemu.gameserver.model.instance.playerreward.OphidanBridgeWarPlayerReward;
...
public class OphidanBridgeWarReward extends InstanceReward<OphidanBridgeWarPlayerReward> {
    ...
    public List<OphidanBridgeWarPlayerReward> sortPoints() {
        ...
        return getInstanceRewards().stream().sorted(Comparator.comparing(OphidanBridgeWarPlayerReward::getScorePoints).reversed()).collect(Collectors.toList());
    }
